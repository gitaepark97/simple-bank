...
// Store defines all functions to excute db queries and transactions
...
// It creates the transfer, add account entreis, and update accounts' balance within a database transaction
